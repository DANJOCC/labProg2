...
/*Sobrecarga de la funcion vectorSum, devuelve el vector resultante de dos vectores por medio
 de sus magnitudes y angulos
*/
...
int main(){
    ...
    Point2D q4=vectorSum(34,45, grad_to_radians(60), grad_to_radians(70));
